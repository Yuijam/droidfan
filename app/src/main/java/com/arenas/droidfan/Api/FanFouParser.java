...
//        model.setName(o.getString("name"));
        ...
        model.setFollowing(booleanToInt(o.getBoolean("following")));
        model.setProtect(booleanToInt(o.getBoolean("protected")));
        model.setNotifications(booleanToInt(o.getBoolean("notifications")));
        model.setVerified(0);
        model.setFollowMe(0);
...
//            );
    ...
    private StatusModel status(JSONObject o, int type, String owner)
        ...
        model.setTruncated(booleanToInt(o.getBoolean("truncated")));
        model.setSelf(booleanToInt(o.getBoolean("is_self")));

        if (o.has("repost_status")) {
            model.setRetweeted(1);
        }
